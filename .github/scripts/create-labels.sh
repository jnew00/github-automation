...
echo ""
echo "Next steps:"
echo "1. Create a GitHub Project (optional - Projects → New Project → Board)"
echo "2. Use Claude Code to parse specs and create issues"
echo "3. Install Claude GitHub App for PR reviews: https://github.com/apps/claude-code"
echo ""
